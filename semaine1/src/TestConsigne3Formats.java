...
public class TestConsigne3Formats {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("test 4 : ouverture mot de passe");
		System.out.println();
		System.out.println("consigne.ouvrirCasier(3, mdp3) "+consigne.libererCasier(3, "mdp3"));
		System.out.println("consigne.ouvrirCasier(1, mdp4) "+consigne.libererCasier(1, "mdp4"));
		System.out.println("consigne.ouvrirCasier(1, mdp3) "+consigne.libererCasier(1, "mdp3"));

		System.out.println();
		System.out.println("liberer le casier qui vient d'etre libere");
		System.out.println();
		System.out.println("consigne.ouvrirCasier(1, mdp3) "+consigne.libererCasier(1, "mdp3"));
