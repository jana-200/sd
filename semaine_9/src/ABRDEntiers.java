...
public class ABRDEntiers {
	...
	private boolean contient(NoeudEntier noeud,int entier){
		...
		if(noeud.entier<entier) return contient(noeud.droit, entier);
	...
	public int min() throws ArbreVideException {
		...
		NoeudEntier noeud = racine;
		while (noeud.gauche != null) { // bbbbczzzz les + petits sont tjrs à gauche !!!!!!
			noeud = noeud.gauche;
		}
	...
	public void supprimeMin() throws ArbreVideException {
		...
		if(racine.gauche == null) racine=racine.droit;
		else {
			NoeudEntier noeudAvant = racine;
			NoeudEntier noeud = racine.gauche;
			while (noeud.gauche != null) { // car les + petits sont tjrs à gauche !!!!!!
				noeudAvant = noeud;
				noeud = noeud.gauche;
			}

			if (noeud == noeudAvant.gauche) { // c chatgpt... j'ai rien compris
				noeudAvant.gauche = noeud.droit;
			} else {
				noeudAvant.droit = noeud.droit;
			}
		}
	}
