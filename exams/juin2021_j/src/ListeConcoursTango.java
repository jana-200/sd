...
public class ListeConcoursTango {
	...
	public int donnerNombreDanseursDeNationalite(String nationalite){
		int count=0;
		for(Danseur danseur: mapDanseurNoeud.keySet()){
			if(danseur.getNationalite().equals(nationalite))
				count++;
		}
	...
	public boolean ajouterCouple (Danseur danseur1, Danseur danseur2) {
		...
		if(danseur1.getSexe()=='H') {
			n1 = new Noeud(danseur1);
			n2 = new Noeud(danseur2);
			mapDanseurNoeud.put(danseur1, n1);
			mapDanseurNoeud.put(danseur2, n2);

		}
		else {
			n1=new Noeud(danseur2);
			n2=new Noeud(danseur1);
			mapDanseurNoeud.put(danseur1, n2);
			mapDanseurNoeud.put(danseur2, n1);
		}
